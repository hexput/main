...
use self::connection_registry::{create_connection_registry, ConnectionRegistry};

/// Shared map of pending remote function/method calls
pub type PendingCalls =
    Arc<RwLock<HashMap<String, tokio::sync::oneshot::Sender<Result<JsonValue, String>>>>>;
